...
<head>
	...
	<title>THE WHITEROSE FOUNDATION </title>
...
<!-- Intro
	================================================== -->
<section id="hero" class="section" style="background-image: url('assets/img/whrose.jpg'); background-size: cover;">
<div class="container">
	<div class="row">
		<div class="col-md-5">
			<div class="herotext">
				<h1 class="wow bounceInDown" data-wow-duration="1s" data-wow-delay="0.1s" style="color:black;">THE WHITEROSE <span class="lighter" style="color:black;">FOUNDATION</span></h1>
				<p class="lead wow zoomIn" data-wow-duration="2s" data-wow-delay="0.5s" style="color:black;">
...
<!-- About
	================================================== -->
<section id="about" class="parallax section" style="background-image: 'assets/img/intro.png';">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<!-- Title -->
				<div class="maintitle">
					<h3 class="section-title"><strong>SUPPORT THE <span class="lighter">CAUSE</span></strong> </h3>
					<p class="lead">
						The Whiterose Foundation was started by Minister Zhi Zhang 'Whiterose' to not only help fund the struggle against the social and economic issues all over the world, but to also raise awareness among the masses about these issues and gather unity to make this world a better place.
					</p>
				</div>
			</div>
			<div class="col-md-12 col-sm-6">
				<div class="service-box wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
					<img src="assets/img/wong.png" alt="" style="width:30%;height:30%;">
					<h3>Minister Zhi Zhang 'Whiterose'</h3>
					<div class="text-left">
						<p>
							Zhi Zhang aka Whiterose is the Chinese Minister of State Security and founder of the world's biggest commonwealth, the Deus Group. A philanthropist by heart, she has donated over 100 Million USD worth to charity to bring about a better change in the world. Whiterose founded The Whiterose foundation as a step towards the change.
						</p>
						<p class="text-center">
						</p>
					</div>
			...
			<div class="col-md-4 col-sm-6">
				<div class="service-box wow zoomIn" data-wow-duration="1.5s" data-wow-delay="0.1s">
					...
					<h3>May 9, 2015 <br/>F-CORP HEADQUARTERS PARK</h3>
					<div class="text-left">
						<p>
							An extremely successful awareness event managed at the F-Corp facility, NYC.
							About 150,000 participants joined the event on site and on the live stream.
						</p>
						<p class="text-center">
			...
			<div class="col-md-4 col-sm-6">
				<div class="service-box wow flipInY" data-wow-duration="1.5s" data-wow-delay="0.1s">
					...
					<h3>150M+ Members</h3>
					<p>
						Biggest non profit organization in the world.
					</p>
					<button type="button" class="btn btn-info btn-md"><a href="#">Learn More</a></button>
				</div>
			</div>
			...
			<div class="col-md-4 col-sm-6">
				<div class="service-box wow flipInY" data-wow-duration="1.5s" data-wow-delay="0.4s">
					...
					<h3>$500M+ Donated</h3>
					<p>
						Together by the people and Whiterose.
					</p>
					<button type="button" class="btn btn-info btn-md"><a href="#">Learn More</a></button>
				</div>
			</div>
...
<!-- Random
	================================================== -->
<section class="parallax section" style="background-image: ''">
	<div class="wrapsection">
